...
abstract class Vehiculo implements Arrancable {
    ...
    public String info(){
        return tipoVehiculo() + ":" + marca + " " + modelo + "(" + anio + ")";
    }
}
...
class Auto extends Vehiculo {
    ...
    @Override
    public String tipoVehiculo() { return "Semana1.Auto"; }
...
class Moto extends Vehiculo {
    ...
    @Override
    public String tipoVehiculo() { return "Semana1.Moto"; }
...
class VehiculoElectrico extends Auto {
    ...
    @Override
    public String tipoVehiculo() { return "Semana1.Vehiculo Electrico"; }
